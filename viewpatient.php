...
<h2><?php echo "".$userdetails["Username"]."";?></h2>
            ...
            <div class="record">
            <p style="font-weight: bold; font-family:sans-serif;">Patient records</p>
        ...
        <div class="name">
                 ...
                 <p style="font-size: 20px;"><?php echo "".$userdetail["Full_name"]."" ?></p>
                  <button>View Profile</button>
                 </div>  
                 <ul class="list">
                    <li>Sex:<span><?php
                    echo $userdetail["Gender"];
                    ?></span><li>
                    <li>Age:<span>
                        <?php
                    echo $userdetail["Age"];
